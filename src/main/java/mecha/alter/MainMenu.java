...
public class MainMenu implements MouseListener {
    ...
    public static enum MAINMENUSTATE {
        MAINMENU, GAME, ENCYCLOPEDIA, CREDITS
    };
    ...
    public void draw(Graphics g) {
        if (mmState == MAINMENUSTATE.MAINMENU) {
            ...
            g2d.drawString("Story Mode",
                    (int) (xTitle + 20 + (storyModeButton.width - storyModeTextWidth) / 2),
                    (int) (yTitle + 30 + titleHeight + buttonSpacing - storyModeTextHeight / 2));
            storyModeButton.setFrame(xTitle + 20, yTitle + titleHeight + buttonSpacing - 50, storyModeButton.width,
                    storyModeButton.height);
            ...
            g2d.drawString("Encyclopedia",
                    (int) (xTitle + 21 + (encyclopediaButton.width - encyclopediaTextWidth) / 2),
                    (int) (storyModeButton.y + 25 + storyModeButton.height + buttonSpacing + encyclopediaTextHeight / 2));
            encyclopediaButton.setFrame(xTitle + 20, storyModeButton.y + storyModeButton.height + buttonSpacing,
                    encyclopediaButton.width, encyclopediaButton.height);
            ...
            g2d.drawString("Credits",
                    (int) (xTitle + 19 + (creditsButton.width - creditsTextWidth) / 2),
                    (int) (encyclopediaButton.y + 25 + encyclopediaButton.height + buttonSpacing + creditsTextHeight / 2));
            creditsButton.setFrame(xTitle + 20, encyclopediaButton.y + encyclopediaButton.height + buttonSpacing,
